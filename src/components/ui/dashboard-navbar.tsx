...
export function DashboardNavBar({
  ...
  // Define navigation items for dashboard - same as landing page (Fitur & Cara Kerja)
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 pt-4 pb-2 flex justify-center">
      <div className="relative max-w-7xl w-full px-3 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16 pb-4">
          {/* Logo */}
          <Link
            href="/"
          ...
          <div className="flex items-center space-x-1 sm:space-x-4">
            {user ? (
              <>
                ...
                <div className="relative hidden sm:block">
                  <motion.button
                    ...
                    className="relative z-10 flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-full transition-all text-gray-600 hover:text-gray-900 bg-white hover:bg-gray-100 shadow-sm"
                  >
                  ...
                  {isProfileMenuOpen && (
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        className="w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100 transition-all duration-200 text-sm"
                      >
                        Logout
                      </motion.button>
                    </motion.div>
                ...
                <div className="relative sm:hidden">
                  <button
                    onClick={() => setIsProfileMenuOpen(!isProfileMenuOpen)}
                    className="relative z-10 flex items-center justify-center w-8 h-8 rounded-full transition-colors text-gray-600 hover:text-gray-900 bg-white shadow-sm"
                  >
              ...
              <Link
                href="/auth"
                className="relative z-10 text-white text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 rounded-full transition-all"
              >
                Login
                <motion.div
            ...
            <motion.button
              ...
              className="lg:hidden text-gray-900 hover:text-gray-700 p-1.5 ml-1 hover:bg-gray-100 rounded-lg transition-all"
            >
              {isMobileMenuOpen ? (
            ...
            {user ? (
              <>
                ...
                <motion.button
                  ...
                  className="w-full text-left px-2 sm:px-4 py-2 sm:py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-all duration-200 text-xs sm:text-sm"
                >
                  Logout
                </motion.button>
              </>
              ...
              >
                <Link
                  ...
                  className="block w-full text-center bg-blue-600 text-white py-2 sm:py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200 text-xs sm:text-sm"
                >
                  Login
                </Link>
              </motion.div>
