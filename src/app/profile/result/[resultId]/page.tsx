...
export default function ResultDetailPage() {
  ...
  const { data: messagesData, isLoading: isMessagesLoading } =
    useSessionMessages(sessionId, { limit: 100 });

  // Jika sudah fetch tapi hasil tidak ada, tampilkan pesan
  useEffect(() => {
    if (!isResultLoading && !resultData) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50">
        <div className="text-center">
          ...
          <p className="text-neutral-600 text-sm">Mohon tunggu sebentar</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-50 via-white to-primary-50">
        ...
        >
          ...
          <p className="text-neutral-600 mb-2 leading-relaxed">
            AI kami sedang menganalisis jawaban Anda secara mendalam untuk
  ...
  if (resultData.verification_status === "pending") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
  ...
  if (resultData.verification_status === "rejected") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
  ...
  const result: AssessmentDetail = {
    ...
    analysis_report: {
      ...
      book_recommendations:
        resultData.analysis_report?.book_recommendations || [],
  ...
  const readinessDisplay = {
    label: getReadinessLabel(result.readiness_level),
    ...colors,
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-primary-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        >
          <div className="bg-primary-600 px-6 sm:px-8 lg:px-12 py-12 text-white">
            ...
            >
              {/* Left Side */}
              <div>
                <p className="text-white text-opacity-90 text-base sm:text-lg mb-3">
                  {result.target_major}
                </p>
                <div className="inline-flex items-center gap-3 bg-white bg-opacity-15 backdrop-blur-sm border-2 border-white border-opacity-30 rounded-2xl px-6 py-3 shadow-lg">
              ...
              {/* Right Side - Insights dengan Kategori */}
              <div className="grid grid-cols-3 gap-4 w-full lg:w-auto">
                {[
                  ...
                  const numScore = typeof insight.value === 'string' ? parseInt(insight.value) : insight.value;
                  const category = numScore >= 90 ? "Sangat Baik" : numScore >= 80 ? "Baik" : numScore >= 70 ? "Cukup Baik" : numScore >= 60 ? "Cukup" : "Perlu Ditingkatkan";
        ...
        {activeTab === "overview" && <DetailedTab result={result} />}
...
function OverviewTab({
  ...
  return (
    ...
    >
      ...
      {result.analysis_report.book_recommendations &&
        result.analysis_report.book_recommendations.length > 0 && (
          <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8">
            <h3 className="text-2xl font-bold text-neutral-900 mb-6 flex items-center space-x-2">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {result.analysis_report.book_recommendations.map(
                (book, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 10 }}
      ...
      {/* Learning Path */}
      {result.analysis_report.learning_path &&
        result.analysis_report.learning_path.length > 0 && (
          <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8">
            <h3 className="text-2xl font-bold text-neutral-900 mb-6 flex items-center space-x-2">
      ...
      {/* Action Plan */}
      {result.analysis_report.action_plan &&
        result.analysis_report.action_plan.length > 0 && (
          <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8">
            <h3 className="text-2xl font-bold text-neutral-900 mb-6 flex items-center space-x-2">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div
                        className={`${colors.badge} w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0`}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <div className="flex items-center space-x-2 flex-shrink-0 ml-2">
                            <span
                              className={`text-xs px-2 py-1 ${colors.badge} text-white rounded-full uppercase font-semibold`}
                            >
                              {action.priority}
                            </span>
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8">
          ...
          <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5">
                ...
                <div className="flex items-center space-x-3 mb-2">
                  <div className="text-3xl font-bold text-primary-600">
                    {result.analysis_report.industry_insights.growth_potential}
                    /10
                  </div>
                  <div className="flex-1 bg-neutral-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${result.analysis_report.industry_insights.growth_potential * 10}%`,
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="font-bold text-neutral-900">
                    {
                      result.analysis_report.industry_insights
                        .salary_progression.entry_level
                    }
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-bold text-neutral-900">
                    {
                      result.analysis_report.industry_insights
                        .salary_progression.senior_level
                    }
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {result.analysis_report.industry_insights.top_companies.map(
                  (company, i) => (
                    <span
                      key={i}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {result.analysis_report.industry_insights.skills_in_demand.map(
                  (skill, i) => (
                    <span
                      key={i}
            ...
            {result.analysis_report.industry_insights.required_certifications &&
              result.analysis_report.industry_insights.required_certifications
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {result.analysis_report.industry_insights.required_certifications.map(
                      (cert, i) => (
                        <span
                          key={i}
    ...
    return (
      <div className="bg-white rounded-2xl shadow-md p-8 text-center">
        <div className="inline-flex items-center justify-center w-12 h-12 bg-primary-100 rounded-full mb-4">
          <ClockIcon className="w-6 h-6 text-primary-600 animate-spin" />
        </div>
        <p className="text-neutral-600">Memuat riwayat chat...</p>
      </div>
    );
  }
  ...
  if (!messages || messages.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-md p-12 text-center">
        ...
        <p className="text-neutral-600">Tidak ada riwayat chat</p>
      </div>
    );
  }
                ...
                {message.message_type === "question" ? (
                  ...
                  <>
                    <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center">
                      <span className="text-white text-xs font-bold">Anda</span>
                    </div>
