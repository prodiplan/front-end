...
export default function ConfirmationPage() {
  ...
  return (
    <div className="h-screen bg-primary-50 flex flex-col overflow-hidden">
      ...
      {/* Main Content */}
      <div className="flex-1 flex items-center justify-center px-2 sm:px-4 py-8 overflow-y-auto">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="max-w-2xl w-full flex flex-col my-auto"
        >
          {/* Success Card */}
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-primary-100 flex flex-col">
            {/* Gradient Header */}
